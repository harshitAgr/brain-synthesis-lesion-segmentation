...
class GeneratorRes(tf.keras.Model):
  ...
  def __init__(self):
    ...
    def convt_block(filters, stage, block, strides=(2,2)):
        return blocks2d._ConvTBlock(
            3,
            filters,
            stage=stage,
            block=block,
    ...
    def id_block(filters, stage, block):
      return blocks2d._IdentityBlock(
    ...
    self.l7a = convt_block([64, 64, 3], stage=7, block='a')
    self.l7b = id_block([64, 64, 3], stage=7, block='b')
    self.l7c = id_block([64, 64, 3], stage=7, block='c')
